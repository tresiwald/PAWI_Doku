...
\todo[inline]{Diagramm neuzeichnen (vektorisiert)}
...
\improvement[inline]{Ort der Implementierung angeben. --> Unterpackages Core + Visualisierung}
...
\end{longtable}
\todo[]{Entscheid ausformulieren + bewertung der Framework inkl. kleiner Text + Screenshoot}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{cytoscape}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{greuler}
